...
class EVTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 160, fontWeight: FontWeight.w400, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 160, fontWeight: FontWeight.w400, color: Colors.white),
